...
public class Galaxy : MonoBehaviour {
	...
	void Start () {
		...
		foreach(GameObject planet in planets) {
			...
			p.Spawn (Resources.Load("Tree"), Random.Range(100,300), .5f);
			p.Spawn (Resources.Load("WaterWell"), Random.Range (30, 80), .4f);
			p.Spawn (Resources.Load("Stone"), Random.Range (40, 90), .4f);
			p.Spawn (Resources.Load("Baker_house"), Random.Range (10, 20), .4f);
